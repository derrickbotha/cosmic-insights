      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-lg p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="relative group">
            <div className="w-20 h-20 bg-white/20 backdrop-blur rounded-full flex items-center justify-center text-4xl overflow-hidden ring-4 ring-white/30">
              {profilePicture ? (
                <img 
                  src={profilePicture} 
                  alt={name} 
          ...
          <div>
            ...
            <p className="text-indigo-100">Welcome back, {name}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
            ...
            <p className="text-lg font-bold text-gray-900 dark:text-white">{birthDate}</p>
          </div>
          ...
          <div className="p-4 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Birth Time</span>
            </div>
            <p className="text-lg font-bold text-gray-900 dark:text-white">{birthTime}</p>
          </div>

          {/* Birth Place */}
          <div className="p-4 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-lg md:col-span-2">
            <div className="flex items-center gap-3 mb-2">
              <svg className="w-5 h-5 text-pink-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
              </svg>
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Birth Place</span>
            </div>
            <p className="text-lg font-bold text-gray-900 dark:text-white">{birthPlace}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Sun Sign</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Your core essence</p>
            <p className="text-2xl font-bold text-primary">{sunSign}</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-3xl">
              🌙
            </div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Moon Sign</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Your emotional nature</p>
            <p className="text-2xl font-bold text-primary">{moonSign}</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-3xl">
              ⭐
            </div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Rising Sign</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Your outer persona</p>
            <p className="text-2xl font-bold text-primary">{risingSign}</p>
          </div>
        </div>
      </div>
